...
public class CustomGrabInteractable : XRBaseInteractable
{
	...
	void SmoothVelocityStart(IXRInteractor interactor)
	{
		...
		System.Array.Clear(m_ThrowSmoothingFrameTimes, 0, m_ThrowSmoothingFrameTimes.Length);
		System.Array.Clear(m_ThrowSmoothingVelocityFrames, 0, m_ThrowSmoothingVelocityFrames.Length);
		System.Array.Clear(m_ThrowSmoothingAngularVelocityFrames, 0, m_ThrowSmoothingAngularVelocityFrames.Length);
